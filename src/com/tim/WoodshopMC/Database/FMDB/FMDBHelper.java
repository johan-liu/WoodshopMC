package com.tim.WoodshopMC.Database.FMDB;
...
public class FMDBHelper extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "woodshopmc.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            String sql_product = "CREATE TABLE tbl_product(product_id INTEGER PRIMARY KEY AUTOINCREMENT, product_name TEXT, deleted INTEGER);";
            String sql_locproduct = "CREATE TABLE tbl_locproduct(locproduct_id INTEGER PRIMARY KEY AUTOINCREMENT, locproduct_locid INTEGER, locproduct_productname TEXT, locproduct_coverage DOUBLE, deleted INTEGER);";
